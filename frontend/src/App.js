        ...
        return (
          <div className="w-full max-w-[280px] h-24 mx-auto mb-3 bg-gradient-to-br from-neutral-900 to-black border-2 border-yellow-400 rounded-2xl p-2.5 flex flex-col justify-between shadow-[0_0_20px_rgba(250,204,21,0.4)] relative overflow-hidden">
            ...
            <div className="grid grid-cols-4 gap-1.5 h-12">
              ...
              <div className="bg-red-500/50 border border-red-400 text-white font-black text-xs rounded-lg flex items-center justify-center animate-bounce">16</div>
            </div>
          </div>
        );
      case 'tetris':
    ...
    <div className="container mx-auto px-4 mb-16 relative z-10">
      <div className={`rounded-3xl shadow-2xl p-6 md:p-8 backdrop-blur-xl border ${
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 items-center">
          ...
          {/* CONTENEDOR CENTRAL DE JUEGO (BLANCO EN TEMA CLARO, NEGRO EN TEMA OSCURO) */}
          <div className={`lg:col-span-2 border-4 rounded-2xl p-5 text-center relative shadow-inner flex flex-col items-center justify-center min-h-[320px] ${
            isLight 
              ? 'bg-white border-purple-200 text-gray-800 shadow-xl' 
            ...
            <h3 className={`text-xl font-black mb-1 uppercase tracking-tight ${isLight ? 'text-purple-700' : 'text-yellow-400'}`}>{currentGame.name}</h3>
            <p className={`text-xs max-w-sm mb-3 leading-relaxed ${isLight ? 'text-gray-600 font-medium' : 'text-neutral-300'}`}>{currentGame.desc}</p>
            <button
